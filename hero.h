...
public:
	...
	void update();	//was virtual in Entity
	void slash();
	void dash();
	void die();	//was abstract in LivingEntity
	void revive();
	void changeAnimation(int newState, bool resetFrameToBeginning); //was abstract in Entity
	void updateAnimation(); 
	void updateDamages(); //was abstract in LivingEntity
};
